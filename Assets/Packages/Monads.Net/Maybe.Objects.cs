...
namespace System.Monads
{
	public static class MaybeObjects
	{
			...
			where TSource : class
		{
			...
			if (source != default(TSource) && !source.Equals(default(TSource)) && !source.Equals(default(TSource)))
			{
				action(source);
			}
		...
		public static TResult With<TSource, TResult>(this TSource source, Func<TSource, TResult> action)
			where TSource : class
		{
			if (source != default(TSource) && !source.Equals(default(TSource)))
			{
		...
		public static TSource If<TSource>(this TSource source, Func<TSource, bool> condition)
			where TSource : class
		{
			if ((source != default(TSource) && !source.Equals(default(TSource))) && (condition(source) == true))
			{
				return source;
			}
			else
		...
		public static TSource IfNot<TSource>(this TSource source, Func<TSource, bool> condition)
			where TSource : class
		{
			if ((source != default(TSource) && !source.Equals(default(TSource))) && (condition(source) == false))
			{
				return source;
			}
			else
		...
		public static bool IsNotNull<TSource>(this TSource source)
			where TSource : class
		{
			return source != default(TSource) && !source.Equals(default(TSource));
		}
	}
}
